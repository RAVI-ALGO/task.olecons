import react, { useEffect, useState } from 'react'
    ...
    import { aboutTranslationEn } from '../translation/aboutT/tEn'
    import { aboutTranslationFr } from '../translation/aboutT/tFr'
    import { aboutTranslationHi } from '../translation/aboutT/tHi'
                    ...
                    <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                        <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                            <header className="mb-4 lg:mb-6 not-format">
                                ...
                                <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">{t('h1')}</h1>
                            </header>
                            <p className="lead">
                                {t('p1')}
                            </p>
