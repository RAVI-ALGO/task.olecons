...
import { translationsEn } from '../translation/tEN'
import { translationsFr } from '../translation/tFr'
import { translationsHi } from '../translation/tHi'
                        ...
                        <header class="mb-4 lg:mb-6 not-format">
                            <address class="flex items-center mb-6 not-italic">
                                <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{t('name')}</a>
                                        <p class="text-base text-gray-500 dark:text-gray-400">{t('post')}</p>
                            ...
                            <h1 class="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">{t('title')}</h1>
                        </header>
                        <p class="lead">
                            {t('p1')}
                        </p>
